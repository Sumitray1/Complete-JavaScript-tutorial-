...
firstMap.set('Name', 'SumitCompanhy');
//here "Name" is key and "SumitCompanhy" is value i.e is whenever we defin the set then ("key ","value");

//we put the key name any data type same goes for value data too
